...
|------|------|----------|--------|------|
| **Phase 1: 数据采集** |
| | 1.1 JSON 解析器 | Python 脚本 |  | 0.25d |
| | 1.2 白名单解析器 | Python 脚本 |  | 0.25d |
| **Phase 2: AI 评分** |
| | 2.1 基础分计算逻辑 | Python 脚本 |  | 0.25d |
| | 2.2 Minimax-2.1 集成 | API 调用 |  | 0.5d |
| | 2.3 评分 Prompt 优化 | Prompt 工程 |  | 0.5d |
| | 2.4 批量评分控制 | Python 脚本 |  | 0.25d |
| **Phase 3: 内容分类** |
| | 3.1 链接正则提取 | Python 脚本 |  | 0.25d |
| | 3.2 金句/机会 AI 判定 | Minimax-2.1 |  | 0.5d |
| **Phase 4: 报告生成** |
| | 4.1 活跃度排行逻辑 | Python 脚本 |  | 0.25d |
| | 4.2 Markdown 模板 | Jinja2 模板 |  | 0.25d |
| | 4.3 文件输出 | Python 脚本 |  | 0.25d |
| **Phase 5: Web 界面** |
| | 5.1 FastAPI 框架搭建 | FastAPI |  | 0.25d |
| | 5.2 API 路由实现 | FastAPI |  | 0.25d |
| | 5.3 HTML 模板开发 | 原生 HTML/CSS |  | 0.5d |
| | 5.4 文件上传/下载 | Python 脚本 |  | 0.25d |
| **Phase 6: 数据存储** |
| | 6.1 SQLite 集成 | SQLite |  | 0.25d |
| | 6.2 历史记录查询 | Python 脚本 |  | 0.25d |
| **Phase 7: 测试** |
| | 7.1 单元测试 | pytest |  | 0.5d |
| | 7.2 集成测试 | 手工测试 |  | 0.5d |
